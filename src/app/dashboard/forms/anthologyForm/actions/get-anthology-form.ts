...
export const getAnthologyForm = async (anthologyId: string | string[]) => {
    ...
    try {
        ...
        const response = await apiFetch(`/cards/anthology/${anthologyId}`, {
            method: 'GET',
        });
        ...
        revalidatePath(`/dashboard/forms/anthologyForm/${anthologyId}/anthologyDetails`);
        return {
