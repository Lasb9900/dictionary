...
export const loadAnthologyForm = async (payload: AnthologyFormValues, anthologyId: string | string[]) => {
    ...
    try {
        const response = await apiFetch(`/cards/update/anthology/${anthologyId}`, {
            method: 'PUT',
            body: { ...payload },
        });
